...
router.post('/add', function(req, res, next) {
  ...
  // post to db successfull
    ...
    // initiate email 
    let html = `<h1 style="font-family: monospace; margin: 0">Jo ${name}, deine Bestellung bei Rolfes\' Seminarfach Pizzabesteller ist eingegangen.</h1> <h1><a style="font-family: monospace;" href="https://malts.me/api/confirm/${validationId}">Bestellung bestätigen</a></h1>`;
    var msg = {
      from: 'me@malts.me',
